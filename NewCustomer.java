...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
		...
		comboBox = new JComboBox<String>(new String[] {"Passport", "Aadhar Card", "Voter Id", "Driving license"});
		...
		t5.setText(currentTimestamp.toString());
		t5.setEditable(false);  // Make it read-only
